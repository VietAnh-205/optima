...
count_1a = sche_unique.groupby('bill_code').size().reset_index(name = 'count_1a') 
...
wh_o1a = (sche_unique[sche_unique['wh_rank'] == 1][['bill_code', 'warehouse_name', 'io_time']].rename(columns = {'warehouse_name': 'kho_o1a', 'io_time': 'time_o1a'}))
...
wh_d1a = (sche_unique[sche_unique['wh_rank_rev'] == 1][['bill_code', 'warehouse_name', 'io_time']].rename(columns = {'warehouse_name': 'kho_d1a', 'io_time': 'time_d1a'})) 
